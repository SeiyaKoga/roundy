...
function Roundy(optProps) {
  ...
  var _wrapper = useRef(null);

  var _handle = useRef(null);
  ...
  }, render ? createElement("div", Object.assign({
  ...
  }), render(state, props)) : createElement(Fragment, null, createElement("svg", {
    ref: _wrapper,
    width: size,
    height: size
  }, sliced && createElement("defs", null, createElement("mask", {
    id: maskName,
...
//# sourceMappingURL=roundy.esm.js.map
